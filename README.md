This is the source code for getting a Selenium IDE edited version plus a python formatter to export python tests that work with Stanislav Dashevskyi Selenium Wrapper.
